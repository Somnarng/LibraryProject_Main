Shader "Unreal/MI_FrostedGlassLit"
{
    Properties
    {
		...
		Material_Texture2D_0( "T_GlassWindow_Normal", 2D ) = "white" {}
		Material_Texture2D_1( "Emissive", 2D ) = "white" {}
		Material_Texture2D_2( "T_GlassWindow_BaseColor", 2D ) = "white" {}
		Material_Texture2D_3( "T_GlassWindow_RMAH", 2D ) = "white" {}
    ...
    SubShader
    {
        ...
        #include "MI_FrostedGlassLit.hlsl"
