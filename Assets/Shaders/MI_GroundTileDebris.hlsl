...
void InitializeExpressions()
{
	...
	Material.PreshaderBuffer[1] = float4(1.000000,0.936235,-0.351376,0.000000);//(Unknown)
	Material.PreshaderBuffer[2] = float4(0.351376,0.936235,1.000000,1.000000);//(Unknown)
	...
	Material.PreshaderBuffer[5] = float4(1.000000,1.000000,1.500000,0.000000);//(Unknown)
	Material.PreshaderBuffer[6] = float4(1.000000,0.895973,0.724992,0.728267);//(Unknown)
	Material.PreshaderBuffer[7] = float4(1.000000,1.000000,1.000000,0.050000);//(Unknown)
	Material.PreshaderBuffer[8] = float4(2.000000,4.428952,1.000000,10.000000);//(Unknown)
...
float3 GetMaterialWorldPositionOffset(FMaterialVertexParameters Parameters)
{
	...
	MaterialFloat Local69 = dot(DERIV_BASE_VALUE(Local68),Material.PreshaderBuffer[0].xy);
	MaterialFloat Local70 = dot(DERIV_BASE_VALUE(Local68),Material.PreshaderBuffer[0].zw);
	MaterialFloat2 Local71 = MaterialFloat2(DERIV_BASE_VALUE(Local69),DERIV_BASE_VALUE(Local70));
	MaterialFloat2 Local72 = (MaterialFloat2(0.50000000,0.50000000) + DERIV_BASE_VALUE(Local71));
	MaterialFloat2 Local73 = (DERIV_BASE_VALUE(Local72) * ((MaterialFloat2)Material.PreshaderBuffer[1].x));
	MaterialFloat4 Local74 = UnpackNormalMap(Texture2DSampleLevel(Material_Texture2D_0,samplerMaterial_Texture2D_0,DERIV_BASE_VALUE(Local73),-1.00000000));
	MaterialFloat Local75 = dot(DERIV_BASE_VALUE(Local68),Material.PreshaderBuffer[1].yz);
	MaterialFloat Local76 = dot(DERIV_BASE_VALUE(Local68),Material.PreshaderBuffer[2].xy);
	MaterialFloat2 Local77 = MaterialFloat2(DERIV_BASE_VALUE(Local75),DERIV_BASE_VALUE(Local76));
	MaterialFloat2 Local78 = (MaterialFloat2(0.50000000,0.50000000) + DERIV_BASE_VALUE(Local77));
	MaterialFloat2 Local79 = (DERIV_BASE_VALUE(Local78) * ((MaterialFloat2)Material.PreshaderBuffer[2].z));
	MaterialFloat4 Local80 = UnpackNormalMap(Texture2DSampleLevel(Material_Texture2D_1,samplerMaterial_Texture2D_1,DERIV_BASE_VALUE(Local79),-1.00000000));
	MaterialFloat4 Local81 = Parameters.VertexColor;
	MaterialFloat Local82 = DERIV_BASE_VALUE(Local81).r;
	MaterialFloat3 Local83 = lerp(Local74.rgb,Local80.rgb,DERIV_BASE_VALUE(Local82));
	MaterialFloat4 Local84 = MaterialCollection0.Vectors[0];
	MaterialFloat2 Local85 = (DERIV_BASE_VALUE(Local67) * ((MaterialFloat2)Local84.g));
	MaterialFloat4 Local86 = UnpackNormalMap(Texture2DSampleLevel(Material_Texture2D_2,samplerMaterial_Texture2D_2,DERIV_BASE_VALUE(Local85),-1.00000000));
	MaterialFloat3 Local87 = (Local86.rgb * ((MaterialFloat3)Local84.b));
	MaterialFloat Local88 = DERIV_BASE_VALUE(Local81).g;
	MaterialFloat3 Local89 = (Parameters.TangentToWorld[2] * ((MaterialFloat3)DERIV_BASE_VALUE(Local88)));
	MaterialFloat Local90 = (Local84.r - 1.00000000);
	MaterialFloat Local91 = (Local89.b + Local90);
	MaterialFloat Local92 = saturate(Local91);
	MaterialFloat3 Local93 = lerp(Local83,Local87,Local92);
	MaterialFloat3 Local94 = (Local93 * ((MaterialFloat3)Material.PreshaderBuffer[2].w));
	MaterialFloat4 Local95 = MaterialCollection0.Vectors[1];
	MaterialFloat3 Local96 = (Local94 * ((MaterialFloat3)Local95.g));
	return Local96;;
}
void CalcPixelMaterialInputs(in out FMaterialPixelParameters Parameters, in out FPixelMaterialInputs PixelMaterialInputs)
{
	...
	MaterialFloat Local97 = lerp(Local56.b,Local60.b,DERIV_BASE_VALUE(Local19));
	MaterialFloat2 Local98 = GetPixelPosition(Parameters);
	MaterialFloat Local99 = View.TemporalAAParams.x;
	MaterialFloat2 Local100 = (Local98 + MaterialFloat2(Local99,Local99));
	MaterialFloat Local101 = CustomExpression0(Parameters,Local100);
	MaterialFloat2 Local102 = (Local98 / MaterialFloat2(64.00000000,64.00000000).rg);
	MaterialFloat Local103 = MaterialStoreTexCoordScale(Parameters, Local102, 4);
	MaterialFloat4 Local104 = ProcessMaterialLinearGreyscaleTextureLookup(Texture2DSampleBias(Material_Texture2D_8,samplerMaterial_Texture2D_8,Local102,View.MaterialTextureMipBias));
	MaterialFloat Local105 = MaterialStoreTexSample(Parameters, Local104, 4);
	MaterialFloat Local106 = (Local101 + Local104.r);
	MaterialFloat Local107 = (Local106 * 0.16665000);
	MaterialFloat Local108 = (0.50000000 + Local107);
	MaterialFloat Local109 = (Local108 + -0.50000000);
	MaterialFloat Local110 = (Material.PreshaderBuffer[8].w * Local109);

	PixelMaterialInputs.EmissiveColor = Local39;
	PixelMaterialInputs.Opacity = 1.00000000;
	PixelMaterialInputs.OpacityMask = Material.PreshaderBuffer[8].z;
	...
	PixelMaterialInputs.AmbientOcclusion = Local97;
