...
void InitializeExpressions()
{
	...
	Material.PreshaderBuffer[1] = float4(0.000000,0.000000,0.000000,1.000000);//(Unknown)
	Material.PreshaderBuffer[2] = float4(0.000000,0.400000,0.000000,0.000000);//(Unknown)
...
void CalcPixelMaterialInputs(in out FMaterialPixelParameters Parameters, in out FPixelMaterialInputs PixelMaterialInputs)
{
	...
	MaterialFloat3 Local10 = lerp(Local8,((MaterialFloat3)Local9),Material.PreshaderBuffer[1].w);
	MaterialFloat Local11 = MaterialStoreTexCoordScale(Parameters, DERIV_BASE_VALUE(Local0), 1);
	MaterialFloat4 Local12 = ProcessMaterialColorTextureLookup(Texture2DSampleBias(Material_Texture2D_2,samplerMaterial_Texture2D_2,DERIV_BASE_VALUE(Local0),View.MaterialTextureMipBias));
	MaterialFloat Local13 = MaterialStoreTexSample(Parameters, Local12, 1);
	MaterialFloat Local14 = (Local12.a * Material.PreshaderBuffer[2].y);

	PixelMaterialInputs.EmissiveColor = Local4;
	PixelMaterialInputs.Opacity = Local14;
	PixelMaterialInputs.OpacityMask = 1.00000000;
	PixelMaterialInputs.BaseColor = Local10;
	PixelMaterialInputs.Metallic = Local12.g;
	PixelMaterialInputs.Specular = Material.PreshaderBuffer[2].x;
	PixelMaterialInputs.Roughness = Local12.r;
	PixelMaterialInputs.Anisotropy = 0.00000000;
	PixelMaterialInputs.Normal = Local2.rgb;
	PixelMaterialInputs.Tangent = MaterialFloat3(1.00000000,0.00000000,0.00000000);
	PixelMaterialInputs.Subsurface = 0;
	PixelMaterialInputs.AmbientOcclusion = Local12.b;
	PixelMaterialInputs.Refraction = MaterialFloat3(MaterialFloat3(1.00000000,0.00000000,0.00000000).xy,Material.PreshaderBuffer[2].z);
